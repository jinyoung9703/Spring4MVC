package com.hello.spring4.aop;

import com.hello.spring4.controller.BoardController;
...
public class MemberServiceAdvice {
    ...
    @Pointcut("execution(* com.hello.spring4.controller.MemberController.myinfo(..))")
    public void myInfoPoint() {}

    @Pointcut("execution(* com.hello.spring4.controller.MemberController.join(..))")
